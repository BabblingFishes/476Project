...
#include "stb_image_write.h" // LINUX
//#include <stb/stb_image_write.h> // WINDOWS
 ...
 */
bool GLTextureWriter::WriteImage(std::shared_ptr<gTexture> texture, std::string fileName)
{
 ...
 */
bool GLTextureWriter::WriteImage(const gTexture &  texture, std::string imgName)
{
